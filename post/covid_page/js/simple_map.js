	  ...
	  .then(function(data) {
		...
		var mouseoverMap = function(event, d) {
			...
			if (variable == "deaths") {
				var html =  "<b>" + d.properties.nome_acento + "</b><br/>" +
										formatValue(d.properties.deaths) + " deaths"				
			} else {
				var html =  "<b>" + d.properties.nome_acento + "</b><br/>" +
										formatValue(d.properties.cases) + " cases"				
			}
		...
		if (first) {
			...
			gMap.append("text")
			    ...
			    .text("Number of cases of COVID-19 on 2020/12/28")
		        .attr("y", -10)
		        .attr("x", 0)
		    ...
		    if (variable == "deaths") {
				...
				gMap.append("text")
					...
					.duration(300)
					.attr("class","title-map")				
				    .text("Number of deaths by COVID-19 on 2020/12/28")
			        .attr("y", -10)
			        .attr("x", 0)
			        .attr("text-anchor", "start")
			        .attr("fill", "black")
