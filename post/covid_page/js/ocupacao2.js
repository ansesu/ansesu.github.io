...
function plotOcupacao(data_path, first) {
  ...
  //Get median of dates
  medianOcupacao = d3.median(data, function(d) { return d.Date; })
  ...
  //Create legend
  var legendRectOcupacao = gOcupacao.selectAll('.legendRect')
  ...
  var legendTextOcupacao = gOcupacao.selectAll('.legend')
                                    .data(categoriesOcupacao)
  ...
  var categoryOcupacao = gOcupacao.selectAll(".line")
                                        .data(categoriesOcupacao)
...
//Create lines
  ...
  // Create tooltip
    ...
    var focusPerLineOcupacao = focusOcupacao.selectAll('.focus-per-line')
                                             .data(categoriesOcupacao)
    ...
    svgOcupacao.append('rect') 
                 ...
                 .on("mouseover", function() {
                   	gOcupacao.selectAll('.tooltip-date').style("display", null); 
                   	gOcupacao.selectAll('.tooltip-text').style("display", null);
            				tooltipTextDateOcupacao.style("display", null);
                    d3.selectAll('#ocupacao .focus-per-line') // circle disappears if data input is changed
                       .attr("opacity", "1")
                    d3.selectAll('#ocupacao .hover-line') // circle disappears if data input is changed
                       .attr("opacity", "1")                    
                 ...
                 .on("mouseout", function() { 			
                   	...
                   	gOcupacao.selectAll('.tooltip-date').style("display", "none"); 
                   	gOcupacao.selectAll('.tooltip-text').style("display", "none");
            				tooltipTextDateOcupacao.style("display", "none");
                    d3.selectAll('#ocupacao .focus-per-line') // circle disappears if data input is changed
                       .attr("opacity", "0")
                    d3.selectAll('#ocupacao .hover-line') // circle disappears if data input is changed
                       .attr("opacity", "0")                    
    ...
    function mousemoveOcupacao(event) { // mouse moving over canvas
        ...
        var tooltipTextOcupacao = gOcupacao.selectAll('.tooltip-text')
                                            .data(categoriesOcupacao)             
        tooltipTextOcupacao.exit()
                           .transition()
                            .duration(0)
                            .attr("opacity", "0")
                            .remove();        
