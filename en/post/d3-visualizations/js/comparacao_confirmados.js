//Margin
const marginConfirmadosComparacao = { top: 10, right: 10, bottom: 40, left: 72 };
...
d3.csv("data/comparacao_confirmados.csv")
  ...
  allGroupConfirmadosComparacao = ['Bologna (ITA)', 'Campina Grande', 'Monterey County (US)',
...
gConfirmadosComparacao.append("text")
  ...
  function mousemoveConfirmadosComparacao(event) {
    ...
    focusConfirmadosComparacaoText.select("#comparacao_confirmados .Maringa")
                    .text(function() { return dTrue_Maringa.Cidade+ ": " + formatValue(dTrue_Maringa.Confirmados) + " cases (" + xDate_Maringa + " days)"; })
                    .attr("position", "absolute")
                    .attr("y", heightConfirmadosComparacao-133)
                    .attr("x", 10);
    focusConfirmadosComparacaoText.select("#comparacao_confirmados .Outro")
                    .text(function() { return dTrue_Outro.Cidade+ ": " + formatValue(dTrue_Outro.Confirmados) + " cases (" + xDate_Outro + " days)"; })
