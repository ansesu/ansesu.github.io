...
svgNetwork.append("text").attr("x", 25).attr("y", 40).text("東山線 - Higashiyama Line").style("font-size", "19px").attr("alignment-baseline","middle")
svgNetwork.append("text").attr("x", 25).attr("y", 80).text("上飯田線 - Kamiida Line").style("font-size", "19px").attr("alignment-baseline","middle")
svgNetwork.append("text").attr("x", 25).attr("y", 120).text("名港線 - Meiko Line").style("font-size", "19px").attr("alignment-baseline","middle")
svgNetwork.append("text").attr("x", 25).attr("y", 160).text("名城線 - Meijo Line").style("font-size", "19px").attr("alignment-baseline","middle")
svgNetwork.append("text").attr("x", 25).attr("y", 200).text("桜通線 - Sakuradori Line").style("font-size", "19px").attr("alignment-baseline","middle")
svgNetwork.append("text").attr("x", 25).attr("y", 240).text("鶴舞線 - Tsurumai Line").style("font-size", "19px").attr("alignment-baseline","middle")

svgNetwork.append("text").attr("x", 1000).attr("y", 35).attr("text-anchor", "end").text("Nagoya Municipal Subway").style("font-size", "30px").attr("alignment-baseline","middle")
